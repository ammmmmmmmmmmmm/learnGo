...
var keys = service.keys$2;

var keys$1 = keys;

var indexOf = service.indexOf_1;

var indexOf$1 = indexOf;

var getOwnPropertySymbols = service.getOwnPropertySymbols$1;
...
function _objectWithoutPropertiesLoose(source, excluded) {
  ...
  for (i = 0; i < sourceKeys.length; i++) {
    key = sourceKeys[i];
    if (indexOf$1(excluded).call(excluded, key) >= 0) continue;
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; service.forEach(_context = ownKeys(Object(source), true)).call(_context, function (key) { service.defineProperty(target, key, source[key]); }); } else if (service.getOwnPropertyDescriptors) { service.defineProperties(target, service.getOwnPropertyDescriptors(source)); } else { var _context2; service.forEach(_context2 = ownKeys(Object(source))).call(_context2, function (key) { service.defineProperty$1(target, key, service.getOwnPropertyDescriptor(source, key)); }); } } return target; }

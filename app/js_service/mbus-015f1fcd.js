...
'OrderService.SetMessage', 'OrderService.SaveSplitOrder', 'OrderService.SetRounding', 'OrderService.MoveRounding', 'OrderService.ReselectSkuOrder', 'OrderService.UpdatePrior']), (_class = /*#__PURE__*/function () {
  ...
  service.createClass(OrderProxy, [{
    ...
    value: function getOrdersByTable(formData, obj, next) {
      obj.res = obj.res.then(function (res) {
        ...
        if (res.status_code == 0) {
          ...
          if (orderData.length) {
            return Promise.all(orderData).then(function (os) {
              // console.log("成功！！！", os)
              for (var key in os) {
    ...
    value: function merge(formData, obj, next) {
      obj.res = obj.res.then(function (res) {
        var _formData$formData = toArray(formData.formData),
            ...
            ids = _formData$formData.slice(1);
          ...
          return GetOrderDb(formData.formData[0].store_id || '').GetOrder(ids).then(function (_o) {
            ...
            if (_o && _o.docs) {
              var _o$docs = toArray(_o.docs),
                  order = _o$docs[0],
                  data = _o$docs.slice(1);

              if (order) {
                order.peopleNumber = parseInt(order.peopleNumber);

                for (var i in data) {
                  var o = data[i];

                  if (o) {
                    order.peopleNumber += parseInt(o.peopleNumber);
                    order.orderLine = [].concat(service.toConsumableArray(order.orderLine), service.toConsumableArray(o.orderLine));
                  }
        ...
        if (res.data && res.data.id && res.status_code == 0) {
          return GetOrderDb(formData.formData[0].store_id || '').GetOrder(res.data.id).then(function (data) {
            if (data) {
              ...
              data.orderLine.map(function (_goods) {
    ...
    key: "getOrder",
    value: function () {
      var _getOrder = service.asyncToGenerator( /*#__PURE__*/service.C__Users____Documents_hipos_service_node_modules__babel_runtime_regenerator.mark(function _callee(payload, obj, next) {
        var _obj$res, client, ticketId, order, store, _obj$res2, c, ticketId2, args;
        ...
        return service.C__Users____Documents_hipos_service_node_modules__babel_runtime_regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                store = _context.sent;
                _obj$res2 = toArray(obj.res), c = _obj$res2[0], ticketId2 = _obj$res2[1], args = _obj$res2.slice(2); //console.log('过虑参数',[c,res, ...args],obj.res)

                obj.res = [c, _objectSpread(_objectSpread({}, store), {}, {
                  order: new service.OrderIndex(order)
                })].concat(service.toConsumableArray(args));
                next();
                _context.next = 19;
                break;
  ...
  return OrderProxy;
}(), (applyDecoratedDescriptor(_class.prototype, "getOrdersByTable", [_dec], Object.getOwnPropertyDescriptor(_class.prototype, "getOrdersByTable"), _class.prototype), applyDecoratedDescriptor(_class.prototype, "getOrderById", [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, "getOrderById"), _class.prototype), applyDecoratedDescriptor(_class.prototype, "getOrdersByZone", [_dec3], Object.getOwnPropertyDescriptor(_class.prototype, "getOrdersByZone"), _class.prototype), applyDecoratedDescriptor(_class.prototype, "merge", [_dec4], Object.getOwnPropertyDescriptor(_class.prototype, "merge"), _class.prototype), applyDecoratedDescriptor(_class.prototype, "switch", [_dec5], Object.getOwnPropertyDescriptor(_class.prototype, "switch"), _class.prototype), applyDecoratedDescriptor(_class.prototype, "getOrder", [_dec6], Object.getOwnPropertyDescriptor(_class.prototype, "getOrder"), _class.prototype)), _class));
...
var TableProxy = (_dec$1 = res('OrderService.GetOrderData'), _dec2$1 = res('OrderService.PlaceOrder'), _dec3$1 = res('OrderService.AddOrder'), _dec4$1 = res('OrderService.AddSkuProduct'), _dec5$1 = res('OrderService.IncreaseOrder'), _dec6$1 = res('OrderService.MinusOrder'), _dec7 = res('OrderService.AddTopping'), _dec8 = res('OrderService.IncreaseTopping'), _dec9 = res('OrderService.MinusTopping'), _dec10 = res('OrderService.OnEmpty'), _dec11 = res('OrderService.GetOrderList'), (_class$1 = /*#__PURE__*/function () {
        ...
        if (res.status_code == 0) {
          ...
          for (var i in res.data) {
            ...
            if (o.tableId) {
              ...
              tableData.push(Promise.resolve(null));
            }
          }

          return Promise.all(tableData).then(function (tdata) {
            //console.log('桌位数据！！！！！！！！', tdata);
            res.data.map(function (obj, index) {
  ...
  return TableProxy;
}(), (applyDecoratedDescriptor(_class$1.prototype, "GetOrderData", [_dec$1], Object.getOwnPropertyDescriptor(_class$1.prototype, "GetOrderData"), _class$1.prototype), applyDecoratedDescriptor(_class$1.prototype, "PlaceOrder", [_dec2$1], Object.getOwnPropertyDescriptor(_class$1.prototype, "PlaceOrder"), _class$1.prototype), applyDecoratedDescriptor(_class$1.prototype, "AddOrder", [_dec3$1], Object.getOwnPropertyDescriptor(_class$1.prototype, "AddOrder"), _class$1.prototype), applyDecoratedDescriptor(_class$1.prototype, "AddSkuProduct", [_dec4$1], Object.getOwnPropertyDescriptor(_class$1.prototype, "AddSkuProduct"), _class$1.prototype), applyDecoratedDescriptor(_class$1.prototype, "IncreaseOrder", [_dec5$1], Object.getOwnPropertyDescriptor(_class$1.prototype, "IncreaseOrder"), _class$1.prototype), applyDecoratedDescriptor(_class$1.prototype, "MinusOrder", [_dec6$1], Object.getOwnPropertyDescriptor(_class$1.prototype, "MinusOrder"), _class$1.prototype), applyDecoratedDescriptor(_class$1.prototype, "AddTopping", [_dec7], Object.getOwnPropertyDescriptor(_class$1.prototype, "AddTopping"), _class$1.prototype), applyDecoratedDescriptor(_class$1.prototype, "IncreaseTopping", [_dec8], Object.getOwnPropertyDescriptor(_class$1.prototype, "IncreaseTopping"), _class$1.prototype), applyDecoratedDescriptor(_class$1.prototype, "MinusTopping", [_dec9], Object.getOwnPropertyDescriptor(_class$1.prototype, "MinusTopping"), _class$1.prototype), applyDecoratedDescriptor(_class$1.prototype, "OnEmpty", [_dec10], Object.getOwnPropertyDescriptor(_class$1.prototype, "OnEmpty"), _class$1.prototype), applyDecoratedDescriptor(_class$1.prototype, "GetOrderList", [_dec11], Object.getOwnPropertyDescriptor(_class$1.prototype, "GetOrderList"), _class$1.prototype)), _class$1));
...
var Name = function Name(__name) {
  ...
  if (!ProxyClass[ProxyName]) {
    ...
    var Ms = Object.getOwnPropertyNames(Object.getPrototypeOf(ProxyClass[ProxyName])); //serviceName
      ...
      Service.prototype[name] = function () {
        ...
        return new Promise(function (resolve, reject) {
          ...
          interceptor.entry(type, {
            formData: [clientData].concat(args),
            data: [clientData].concat(args)
            ...
            Promise.resolve(obj.res).then(function (res) {
              //console.log("结果：",res);
              //结果集拦截
              response.entry(type, {

...
function sync(obj) {
  ...
  service.map(_context = obj.children || []).call(_context, function (o) {
    //console.log(o.code + ":")
...
var CouponsConfig$1 = (function (obj) {
  ...
  return service.promise.resolve().then(function () {
    var _context2;

    service.map(_context2 = obj.children || []).call(_context2, function (o) {
      //console.log(o.code + ":")
      var key = configObj[o.code] || "default";
      var config = CouponsConfig[o.biz_code] || CouponsConfig[key] || CouponsConfig["default"]; //console.log(config)
